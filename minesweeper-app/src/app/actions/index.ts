...
export const loadBoardGame = createAction('[board-game] load', props<{ boardGame: Array<Array<Square>>, gameBoardLength: number, availableMarks: number, installedMines: number }>());
